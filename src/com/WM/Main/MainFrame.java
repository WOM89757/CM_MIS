//Source file: C:\\Users\\茂\\Desktop\\课设\\管理信息系统\\MIS\\CMMIS\\src\\com\\WM\\Main\\MainFrame.java
...
import com.WM.login.LoginDialog;
...
public class MainFrame extends JFrame 
{
   ...
   private JPanel getStatePanel() 
   {
		if (statePanel == null) {// 状态面板对象为空
			...
			nameLabel = new JLabel("紫阁525科技创作有限公司   ");// “公司名称”标签
   ...
   {// 初始化主窗体的方法
		...
		this.setTitle("创梦沙龙管理信息系统");// 设置窗体的题目    
   }
   
   /**
   @return javax.swing.JPanel
   @roseuid 5D0B97C902D3
    */
