//Source file: C:\\Users\\茂\\Desktop\\课设\\管理信息系统\\MIS\\CMMIS\\src\\com\\WM\\iframe\\inventoryGL\\priceAlter.java
...
public class priceAlter extends JInternalFrame 
{
   ...
   {// 价格调整窗体的构造方法
		...
		closeButton.addActionListener(new ActionListener() {// 为“关闭”按钮添加动作事件的监听
			public void actionPerformed(final ActionEvent e) {
				priceAlter.this.doDefaultCloseAction();// 关闭价格调整窗体
			}
		});
